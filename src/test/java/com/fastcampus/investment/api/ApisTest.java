...
class ApisTest {
    ...
    void _01_findAllOpenProductsApiTest() throws Exception {
        ...
        result.andDo(print())
                ...
                .andExpect(jsonPath("$.data[0].totalInvestAmount", is(100_000_000)))
                ...
                .andExpect(jsonPath("$.data[1].totalInvestAmount", is(600_000_000)))
    ...
    void _04_cancelInvestmentApiTest() throws Exception {
        ...
        after.andDo(print())
                ...
                .andExpect(jsonPath("$.data[0].product.id", is(1)))
                .andExpect(jsonPath("$.data[0].product.title", is("You can be elon musk")))
                .andExpect(jsonPath("$.data[0].product.totalInvestAmount", is(100_000_000)))
                .andExpect(jsonPath("$.data[0].investedAmount", is(10_000)))
